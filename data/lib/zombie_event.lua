...
-- POSITIONS
ZE_blockEnterItemPosition = {x= 649, y=389, z=7}
ZE_enterPosition = {x = 617, y = 665, z = 15}
ZE_kickPosition = {x=655, y=399, z=7}
ZE_spawnFromPosition = {x = 597, y = 649, z = 15}
ZE_spawnToPosition = {x = 643, y = 686, z = 15}
-- ITEM IDS
ZE_blockEnterItemID = 1257
-- STORAGES
-- - player

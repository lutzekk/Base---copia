...
function doReborn (cid, level, looktype, vocation)
	...
	player:remove()
	db.query("UPDATE `players` SET `level`="..level..", `experience`= 0 WHERE `players`.`id`= ".. playerid .."")
	db.query("UPDATE `players` SET `looktype`="..looktype.." WHERE `players`.`id`= ".. playerid .."")
	db.query("UPDATE `players` SET `vocation`="..vocation.." WHERE `players`.`id`= ".. playerid .."")
	 return true
 end

...
function onUse(cid, item, frompos, item2, topos)
   	...
   	if item.uid == 7013 and item.itemid == 1945 then
		player1pos = {x=111, y=104, z=8, stackpos=253}
		player1 = getThingfromPos(player1pos)

		player2pos = {x=112, y=104, z=8, stackpos=253}
		player2 = getThingfromPos(player2pos)

		player3pos = {x=113, y=104, z=8, stackpos=253}
		player3 = getThingfromPos(player3pos)

		player4pos = {x=114, y=104, z=8, stackpos=253}
		...
		if player1.itemid > 0 and player2.itemid > 0 and player3.itemid > 0 and player4.itemid > 0 then
			...
			if queststatus1 == -1 and queststatus2 == -1 and queststatus3 == -1 and queststatus4 == -1 then
				nplayer1pos = {x=21, y=1217, z=7}
				nplayer2pos = {x=22, y=1217, z=7}
				nplayer3pos = {x=23, y=1217, z=7}
				nplayer4pos = {x=24, y=1217, z=7}
	...
	elseif item.uid ==7013 and item.itemid == 1946 then

...
mwallpos = {x=658, y=45, z=8, stackpos=1} -- pozycja pierwszej sciany
mwall1pos = {x=658, y=46, z=8, stackpos=1} -- pozycja drugiej sciany
getpiece1 = getThingfromPos(mwall1pos)
if item.uid == 7061 and item.itemid == 1945 and getpiece1.itemid == 1497 then
...
elseif item.uid == 7061 and item.itemid == 1946 then

...
mwall1pos = {x=220, y=308, z=6, stackpos=1} -- pozycja drugiej sciany
getpiece1 = getThingfromPos(mwall1pos)
if item.uid == 7023 and item.itemid == 1945 and getpiece1.itemid == 1497 then
...
elseif item.uid == 7023 and item.itemid == 1946 then

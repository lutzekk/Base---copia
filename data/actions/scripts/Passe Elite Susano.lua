...
local storageplayer = getPlayerStorageValue(cid, 13510)
...
setPlayerStorageValue(cid, 13510, time)
local quantity = math.floor((getPlayerStorageValue(cid, 13510) - timenow)/(24 * 60 * 60))

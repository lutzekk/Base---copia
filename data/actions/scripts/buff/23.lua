function onUse(cid, item, fromPosition, itemEx, toPosition)
    ...
    setConditionParam(condition, CONDITION_PARAM_TICKS, 40000) -- 30 segundos
    setConditionParam(condition, CONDITION_PARAM_STAT_MAXHITPOINTS, 5000)
    setConditionParam(condition, CONDITION_PARAM_STAT_MAXMANAPOINTS, 5000)

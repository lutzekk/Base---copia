function onUse(cid, item, fromPosition, itemEx, toPosition)
    ...
    setConditionParam(condition, CONDITION_PARAM_TICKS, 60000) -- 30 segundos
    setConditionParam(condition, CONDITION_PARAM_SKILL_CLUB, 40) 
    setConditionParam(condition, CONDITION_PARAM_SKILL_SWORD, 40)
    setConditionParam(condition, CONDITION_PARAM_STAT_MAXHITPOINTS, 4000)
    setConditionParam(condition, CONDITION_PARAM_STAT_MAXMANAPOINTS, 4000)

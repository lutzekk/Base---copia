...
mwallpos = {x=543, y=107, z=8, stackpos=1} -- pozycja pierwszej sciany
mwall1pos = {x=544, y=107, z=8, stackpos=1} -- pozycja drugiej sciany
getpiece1 = getThingfromPos(mwall1pos)
if item.uid == 7063 and item.itemid == 1945 and getpiece1.itemid == 1497 then

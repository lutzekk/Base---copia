...
if getPlayerStorageValue(cid, 13521) - os.time() <= 0 then
...
setPlayerStorageValue(cid, 13521, time)
local quantity = math.floor((getPlayerStorageValue(cid, 13521) - timenow)/(24 * 60 * 60))

...
local storageplayer = getPlayerStorageValue(cid, 13520)
local timenow = os.time()

if getPlayerStorageValue(cid, 13520) - os.time() <= 0 then
...
setPlayerStorageValue(cid, 13520, time)
local quantity = math.floor((getPlayerStorageValue(cid, 13520) - timenow)/(24 * 60 * 60))

...
if getPlayerStorageValue(cid, 13522) - os.time() <= 0 then
...
setPlayerStorageValue(cid, 13522, time)
local quantity = math.floor((getPlayerStorageValue(cid, 13522) - timenow)/(24 * 60 * 60))

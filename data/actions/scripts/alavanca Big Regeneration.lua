...
local config = {
itemNec = 13886, -- ID do item que necessita para efetuar a troca
qtNec = 1000, -- Quantidade do item que necessita para efetuar a troca
itemNovo = 13888, -- ID do item que sera adicionado ao efetuar a troca
qtNova = 1, -- Quantidade do item que sera adicionado ao efetuar a troca
stor = 258787, -- Storage, ou seja, a numeracao que identificara se o usuario fez ou nao fez a quest ainda
}

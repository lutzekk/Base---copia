...
mwallpos = {x=726, y=155, z=8, stackpos=1} -- pozycja pierwszej sciany
mwall1pos = {x=726, y=156, z=8, stackpos=1} -- pozycja drugiej sciany
getpiece1 = getThingfromPos(mwall1pos)
if item.uid == 7071 and item.itemid == 1945 and getpiece1.itemid == 1497 then
...
elseif item.uid == 7071 and item.itemid == 1946 then

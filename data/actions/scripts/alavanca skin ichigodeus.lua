...
itemNovo = 14282, -- ID do item que sera adicionado ao efetuar a troca
qtNova = 1, -- Quantidade do item que sera adicionado ao efetuar a troca
stor = 25909, -- Storage, ou seja, a numeracao que identificara se o usuario fez ou nao fez a quest ainda
}

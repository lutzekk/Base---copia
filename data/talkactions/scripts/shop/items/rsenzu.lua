...
local addons = {
ITEM = {8380, 2}, -- ITEM QUE VOCÊ USA COMO MOEDA NO JOGO , REÇO DA VIP
}
function onSay(cid, words, param,channel)
if getPlayerItemCount(cid, addons.ITEM[1]) >= addons.ITEM[2] then
doPlayerAddItem(cid, 3956, 100)
doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "[DBKO SHOP]: congratulations you bought 100x Red Senzu")

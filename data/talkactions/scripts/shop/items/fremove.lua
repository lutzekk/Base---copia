...
local addons = {
ITEM = {8380, 5}, -- ITEM QUE VOCÊ USA COMO MOEDA NO JOGO , REÇO DA VIP
}
function onSay(cid, words, param,channel)
if getPlayerItemCount(cid, addons.ITEM[1]) >= addons.ITEM[2] then
doPlayerAddItem(cid, 4852, 1)
doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "[DBKO SHOP]: congratulations you bought 1x Frag Remover")

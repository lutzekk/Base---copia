function onSay(cid, words, param, channel)
	...
	doPlayerPopupFYI(cid, "Information about player" ..
		...
		"\nStatus:" ..
			"\nLevel - " .. getPlayerLevel(pid) .. ", Ki Level - " .. getPlayerMagLevel(pid) .. ", Speed - " .. getCreatureSpeed(pid) ..
			"\nHealth - " .. getCreatureHealth(pid) .. " / " .. getCreatureMaxHealth(pid) .. ", Mana - " .. getCreatureMana(pid) .. " / " .. getCreatureMaxMana(pid) ..
			"\nSkills:" ..
			"\nHand Ability - " .. getPlayerSkillLevel(pid, SKILL_FIST) .. ", Weapon - " .. getPlayerSkillLevel(pid, SKILL_CLUB) .. ", Sword - " .. getPlayerSkillLevel(pid, SKILL_SWORD) .. ", Strenght - " .. getPlayerSkillLevel(pid, SKILL_AXE) ..
			"\nKi Blasting - " .. getPlayerSkillLevel(pid, SKILL_DISTANCE) .. ", Defense - " .. getPlayerSkillLevel(pid, SKILL_SHIELD) .. ", Fishing - " .. getPlayerSkillLevel(pid, SKILL_FISHING) ..
		"\nCash:" ..
			"\nGolds - " .. getPlayerItemCount(pid, 2160) .. ", Dollars - " .. getPlayerItemCount(pid, 2152) .. ", Cents - " .. getPlayerItemCount(pid, 2148) ..

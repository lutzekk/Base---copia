...
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -6.0, 0, -6.0, 0)

local combat2 = createCombatObject()
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_ENERGYDAMAGE)
setCombatParam(combat2, COMBAT_PARAM_EFFECT, 28)
setCombatParam(combat2, COMBAT_PARAM_DISTANCEEFFECT, 42)
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, -6.0, 0, -6.0, 0)
...
setCombatFormula(combat3, COMBAT_FORMULA_LEVELMAGIC, -6.0, 0, -6.0, 0)
...
setCombatFormula(combat4, COMBAT_FORMULA_LEVELMAGIC, -6.0, 0, -6.0, 0)

local combat5 = createCombatObject()
setCombatParam(combat5, COMBAT_PARAM_TYPE, COMBAT_ENERGYDAMAGE)
setCombatParam(combat5, COMBAT_PARAM_EFFECT, 28)
setCombatParam(combat5, COMBAT_PARAM_DISTANCEEFFECT, 42)
setCombatFormula(combat5, COMBAT_FORMULA_LEVELMAGIC, -6.0, 0, -6.0, 0)

...
local Tile2 = {x = 951, y = 858, z = 10} -- onde o player target teleportado
...
doPlayerSendCancel(cid, "Voc� nao pode usar o Kamui aqui!")
return false
end
...
doPlayerSendTextMessage(target,25,"Voc� esta preso no Kamui por 5 Segundos!")

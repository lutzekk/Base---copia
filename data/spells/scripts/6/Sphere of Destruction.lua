...
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -100.0, 0, -120.0, 0)
local combat2 = createCombatObject()
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_ENERGYDAMAGE)
setCombatParam(combat2, COMBAT_PARAM_EFFECT, 233)
setCombatParam(combat2, COMBAT_PARAM_DISTANCEEFFECT, 15)
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, -100.0, 0, -120.0, 0)
...
setCombatFormula(combat3, COMBAT_FORMULA_LEVELMAGIC, -100.0, 0, -120.0, 0)

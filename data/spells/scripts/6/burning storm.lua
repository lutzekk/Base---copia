...
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -90, 0, -90, 0)

local combat2 = createCombatObject()
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_ENERGYDAMAGE)
setCombatParam(combat2, COMBAT_PARAM_EFFECT, 9)
setCombatParam(combat2, COMBAT_PARAM_DISTANCEEFFECT, 24)
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, -90, 0, -90, 0)
...
setCombatFormula(combat3, COMBAT_FORMULA_LEVELMAGIC, -90, 0, -90, 0)

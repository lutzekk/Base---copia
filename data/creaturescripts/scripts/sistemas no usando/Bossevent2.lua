local config = {
monster = {"[EVENTO] Tapion"}, -- nome dos monstros, separado por vírgulas.
item = {[1] = 12390}, -- [um numero maior que o anterior] = ID do item1, ID do item2, ID do item3...
qnt = {[1] = 100}, -- [um numero maior que o anterior] = quantidade do item1, quantidade do item2, quantidade do item3...

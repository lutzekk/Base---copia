...
function gameStoreInitialize()
	...
	addCategory("Items", "Tools, Dolls & Boxes.", "item", 8505)
	addItem("Items", "Gold", "Gold", 2160, 100, 500)
	addItem("Items", "Senzu Bean", "Senzu Bean", 2673, 100, 500)
	addItem("Items", "Enchanted Senzu", "Enchanted Senzu", 3956, 100, 1000)
	addItem("Items", "Band Of Loss", "Band of Loss", 6300, 1, 100)
	addItem("Items", "Dragon Ball Backpack", "Backpack", 4360, 1, 500)
	addItem("Items", "Super Weapon Enchant Item", "Super Weapon Enchant Item.", 8385, 1, 500)
	addItem("Items", "Potaras", "Potaras.", 2353, 1, 100)
	addItem("Items", "Majin Ki", "Majin Ki. 1 Majin Ki", 8574, 1, 100)
	addItem("Items", "Majin Ki(10)", "Majin Ki. 10 Majin Ki", 8574, 10, 800)
	addItem("Items", "Majin Ki(25)", "Majin Ki. 25 Majin Ki", 8574, 25, 2000)
	addItem("Items", "Event loss box", "Event loss box", 8505, 1, 1500)
	addItem("Items", "1 Lvl Item Loss", "1 Lvl Item Loss.", 8962, 1, 500)
	addItem("Items", "100 Lvl Item Loss", "100 Lvl Item Loss.", 8963, 1, 750)
	-- addItem("Items", "Outfit Doll", "Use this to obtain one outfit with full Addons.", 8982, 1, 300)
	addItem("Items", "200 Lvl Item Loss", "200 Lvl Item Loss.", 8964, 1, 1500)
	addItem("Items", "Goku Box", "Goku Box", 8965, 1, 700)
	addItem("Items", "Xicor Box", "Xicor Box", 8966, 1, 2500)
	-- addItem("Items", "Stamina Refiller", "Can be used to fully recharge your stamina.", 21705, 1, 400)
	addItem("Items", "God Box", "God Box", 8967, 1, 4000)
	addItem("Items", "Grand Saiyan Box", "Grand Saiyan Box", 8968, 1, 4000)
	addItem("Items", "Cabba Box", "Cabba Box", 8969, 1, 4000)
	addItem("Items", "Glove Box", "Glove Box", 8959, 1, 4000)
	addItem("Items", "Sword Box", "Sword Box", 8961, 1, 4000)
	addItem("Items", "Distance Box", "Distance Box", 8960, 1, 4000)
	addItem("Items", "Saiyan Ring", "Saiyan Ring", 8359, 1, 1500)

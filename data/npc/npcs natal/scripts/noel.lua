...
function onThink()              npcHandler:onThink()                    end   
        ...
        if getPlayerStorageValue(cid, 34234) == 4 and getPlayerStorageValue(cid, 34235) == 4 and getPlayerStorageValue(cid, 34236) == 4 and getPlayerStorageValue(cid, 34237) == 4 and getPlayerStorageValue(cid, 34238) == 4 and getPlayerStorageValue(cid, 34239) == 4 then     
                ...
                npcHandler:say('Sorry you Dont have that item!', cid)   
                end 
        else
                npcHandler:say('Sorry, you have already traded with me.', cid)
        end
...
local node1 = keywordHandler:addKeyword({'ajudar'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Verdade? Eu não consigo encontar meus 3 ajudantes e minhas 3 renas.. Voce me ajuda entao?'})   

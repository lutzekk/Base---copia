...
function greetCallback(cid)
  doSendDialogNpc(cid, getNpcId(), "What do you want? fight with me?", "Exit&Yes")
  selfSay("What do you want? fight with me?,{Yes}" ,cid)
  return true             
end
...
function creatureSayCallback(cid, type, msg)
  ...
  if msgcontains(msg:lower(), "yes") then
	...
	if getPlayerStorageValue(cid,8000) == count-1 then
	  ...
	  message = "Get Lost, I need to defeat Goku first."
	    selfSay("Get Lost, I need to defeat Goku first." ,cid)
	else

...
function greetCallback(cid)
  doSendDialogNpc(cid, getNpcId(), "Hahahaha im the strongest in the world, do you want to fight with me?", "Exit&Yes")
  selfSay("Hahahaha im the strongest in the world, do you want to fight with me?, {Yes}" ,cid)

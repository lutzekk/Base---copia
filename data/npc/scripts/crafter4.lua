...
local craft = {
["patroler bandana"] = {reward = {{7728, 1}}, items = {{id = 7930, count = 5},{id = 7724, count = 1}, {id = 7939, count = 13}}},
["patroler armor"] = {reward = {{7729, 1}}, items = {{id = 7930, count = 5},{id = 7725, count = 1}, {id = 7932, count = 13}}},
["patroler legs"] = {reward = {{7730, 1}}, items = {{id = 7930, count = 5},{id = 7726, count = 1}, {id = 7935, count = 13}}},
["patroler boots"] = {reward = {{7731, 1}}, items = {{id = 7930, count = 5},{id = 7727, count = 1}, {id = 7931, count = 13}}}
}

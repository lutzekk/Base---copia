local config = {
    ...
    position = {
        player = Position(58, 127, 6),  -- Posição que o player deve estar
        money = Position(59, 128, 6),   -- Posição do dinheiro
        dice = Position(60, 128, 6)     -- Posição de onde estará o dado
    },
    effects = {

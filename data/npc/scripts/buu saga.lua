...
function greetCallback(cid)
    ...
    if player:getStorageValue(8000) == 48 then
        openNpcDialog(player, Npc():getId(),
            "Hahahaha im the strongest in the world, do you want to fight with me?",
            "Close&Yes"
        )
    else
        openNpcDialog(player, Npc():getId(),

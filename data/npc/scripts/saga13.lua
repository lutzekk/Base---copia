...
function greetCallback(cid)
  doSendDialogNpc(cid, getNpcId(), "I will go to defeat Babidi, you better fight with Vegeta ok?", "Exit&Yes")
    	  selfSay("I will go to defeat Babidi, you better fight with Vegeta ok?, {Yes}" ,cid)

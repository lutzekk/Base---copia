...
function greetCallback(cid)
  doSendDialogNpc(cid, getNpcId(), "Its C17 He are very strong, you must fight with him ok?", "Exit&Yes")
  elfSay("Its C17 He are very strong, you must fight with him ok?" ,cid)
  return true             
end

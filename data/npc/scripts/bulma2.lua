...
function creatureSayCallback(cid, type, msg)
    ...
    if msg == "yes" then
        if player:getStorageValue(8000) == 16 then
            player:setStorageValue(8000, 17)
            openNpcDialog(player, Npc():getId(), "Thank you! Now go!", "Close")
        else

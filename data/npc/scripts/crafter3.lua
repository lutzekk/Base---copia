...
local craft = {
["zamasu potaras"] = {reward = {{7724, 1}}, items = {{id = 7930, count = 4},{id = 8208, count = 1}, {id = 7932, count = 10}}},
["zamasu armor"] = {reward = {{7725, 1}}, items = {{id = 7930, count = 4},{id = 8209, count = 1}, {id = 7927, count = 10}}},
["zamasu legs"] = {reward = {{7726, 1}}, items = {{id = 7930, count = 4},{id = 8210, count = 1}, {id = 7929, count = 10}}},
["zamasu boots"] = {reward = {{7727, 1}}, items = {{id = 7930, count = 4},{id = 8211, count = 1}, {id = 7940, count = 10}}}
}

...
selfSay("Voce esta PK!", cid)
        ...
        elseif((msg == "hi") and not (isFocused(cid)) and (getPlayerStorageValue(cid, stor) ~= 167) and getNpcDistanceToCreature(cid) <= 2) then
		...
		elseif (isFocused(cid) and msg == "yes" and (getPlayerStorageValue(cid, stor) == 167)) then
		selfSay("Ok, cuidado", cid)
        setPlayerStorageValue(cid, stor, 168)
